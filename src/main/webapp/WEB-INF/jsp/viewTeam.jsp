...
<div class = "teamTable">
<table class="teamTable table table-striped">
<tr>
	<th>First Name</th>
	<th>Last Name</th>
	<th>Email</th>
...
<c:choose>
	...
	<c:otherwise>
		<c:url var = "salesmanPage" value = "/salesmanPage?userName=${teamMember.userName }"/>
		<tr>
			<td><a class = "nameLink" href = "${salesmanPage }"><c:out value = "${teamMember.firstName }"/></a></td>
